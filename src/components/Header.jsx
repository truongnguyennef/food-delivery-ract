...
const Header = () => {
  ...
  return (
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-zinc-200'>
       {/* desktop & tablet */}
        <div className='hidden md:flex w-full h-full item-center justify-between'>
            ...
            <div className='flex items-center gap-8'>
                ...
                className='flex items-center gap-8 '>
                    <li className='text-base text-zinc-700 hover:text-headingColor duration-100
                ...
                <div className='relative flex items-center justify-center' onClick={showCart}>
                    <MdShoppingBasket className='text-zinc-700 text-2xl ml-8 cursor-pointer'/>
                ...
                <div className='relative'>
                    ...
                    />
                  {
                    isMenu && (
                        ...
                        className='w-40 bg-slate-200 shadow-xl rounded-lg flex flex-col absolute top-12 
                        right-0 '>
                            {user && user.email === "hiltiger123@gmail.com" &&(
                                    <Link to={"/createItem"}>
                                        <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 
                                        transition-all duration-100 ease-in-out text-zinc-700 text-base'
                                          >
                                            New Item<MdAdd /></p>
                                    </Link>
                            )}
        ...
        <div className='flex items-center justify-between md:hidden w-full h-full '>
            <div className='relative flex items-center justify-center'
                onClick={showCart}>
                <MdShoppingBasket className='text-zinc-700 text-2xl cursor-pointer'/>
                <div className='absolute -top-2 -right-2 w-5 h-5 rounded-full 
                    bg-red-600 flex items-center justify-center'>
                    ...
                    />
                  {
                    isMenu && (
                        ...
                        right-0 '>
                            ...
                            <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-slate-300 gap-3 cursor-pointer hover:bg-slate-400 
                            transition-all duration-100 ease-in-out text-zinc-700 text-base'
                                onClick={logout}    
                            >
                                Logout<MdLogout />
